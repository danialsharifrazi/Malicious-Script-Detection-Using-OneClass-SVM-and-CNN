...
# Feature Selection
x_data,y_data=FSelection(x_data,y_data)
...
for train,test in kfold.split(x_data,y_data):
    ...
    calback=CSVLogger(f'./results/proposed/logger_fold{fold_number}.log')
    ...
    model.save(f'./results/proposed/CNN_fold{fold_number}.h5')
...
path=f'./results/proposed/CNN_Results.txt' 
f1=open(path,'a')
